...
if __name__ == "__main__":
    ...
    loader = RetrieverDataset("wikimultihopqa", "wikimultihopqa-corpus",
                              "config.ini", Split.TRAIN, tokenizer=None)
    ...
    with open('output_json_qrels_train2.json', 'w') as output_file:
        json.dump(qrels, output_file)
    with open('output_json_queries_train2.json', 'w') as output_file:
