...
data = None
with open('../output_json_qrels_train2.json', 'r') as file:
    data = json.load(file)

with open('../output_query_id_to_new_id_train2.json', 'r') as file:
...
with open('output_qrels_train2.tsv', 'w') as output_file:
